...
- `comboName(combo): string` – English display name: 'Single', 'Pair', 'Triple', 'Triple + single', 'Triple + pair', 'Straight of 5', 'Pair chain of 3', 'Airplane of 2', 'Airplane + singles', 'Airplane + pairs', 'Four + two singles', 'Four + two pairs', 'Bomb', 'Rocket'.
